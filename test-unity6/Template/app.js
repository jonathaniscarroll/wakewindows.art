(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/wake-demo-1.loader.js";
    var config = {
        dataUrl: buildUrl + "/wake-demo-1.data",
        frameworkUrl: buildUrl + "/wake-demo-1.framework.js",
        codeUrl: buildUrl + "/wake-demo-1.wasm",
